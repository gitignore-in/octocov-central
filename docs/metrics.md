...
After octocov generates `README.md`, the `Collect` workflow applies three
...
"Prepend generated-file marker and commit".
...
3. **Metric Values link**: Inserts the line
...
see these three differences. They are intentional workflow additions, not
octocov changes.
